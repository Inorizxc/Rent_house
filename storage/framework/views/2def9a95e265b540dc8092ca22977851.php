...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <?php if($selectedTable): ?>
        ...
        <div class="bg-white shadow rounded p-6">
            <h2 class="text-xl font-semibold">Таблица «<?php echo e($selectedTable); ?>»</h2>
...
<div class="pagination-container">
  <div class="pagination">
    <a href="?table=<?php echo e(urlencode($selectedTable)); ?>&page=<?php echo e(max(1, $p-1)); ?>&per=<?php echo e($limit); ?>"
        ...
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
                <a href="?table=<?php echo e(urlencode($selectedTable)); ?>&page=<?php echo e($it); ?>&per=<?php echo e($limit); ?>"
                class="pag-num <?php echo e($it==$p ? 'pag-active' : ''); ?>"><?php echo e($it); ?></a>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <a href="?table=<?php echo e(urlencode($selectedTable)); ?>&page=<?php echo e(min($N, $p+1)); ?>&per=<?php echo e($limit); ?>"
...
document.addEventListener('click', function(e) {
    if (e.target && e.target.classList.contains('pag-ellipsis')) {
        ...
        params.set('per', String(<?php echo json_encode($limit, 15, 512) ?>)); // <-- сохраняем лимит
...
</html><?php /**PATH G:\RentHouse\Rent_house\resources\views/test.blade.php ENDPATH**/ ?>